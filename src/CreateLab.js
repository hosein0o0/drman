    ...
    return(
        <React.Fragment>
            <div className='m-1 field col-12'>
                    ...
                    <div className='value col-8'>
                    <input name='name' type='text' placeholder = 'نام آزمایشگاه' required onChange ={this.handlechange} onBlur={this.handleCheck}/>
                </div>
                </div>
                ...
                <button className='submit_sign m-1' type='submit' onClick={this.handlesubmit}>ثبت آزمایشگاه</button>
                <span onClick={()=>this.props.changeHandle(true)}>ثبت کلینیک</span>
                </div>
        </React.Fragment>
    )
}
